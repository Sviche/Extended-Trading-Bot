...
TRADING_SETTINGS = {
    ...
    'leverage': {
        'BTC': [45, 50, 1],   # [min, max, шаг] — рандомный leverage от 40 до 50 с шагом 1
        'ETH': [45, 50, 1],   # Можно задать одно число (например 50) — фиксированный leverage
    },
...
POSITION_MANAGEMENT = {
    ...
    # Стоплосс (нативный биржевой TPSL + клиентский фоллбэк)
    'stop_loss_enabled': True,         # Включить/выключить стоплосс
